...
import com.mock.interview.repository.InterviewEntityRepository;
import com.mock.interview.service.InterviewService;
import com.mock.interview.service.InterviewTemplateService;
import com.mock.interview.service.NotificationService;
import com.mock.interview.service.mapper.InterviewMapper;
...
public class InterviewServiceImpl extends GenericSpecificationService<InterviewEntity, Long> implements InterviewService {
    ...
    private static final InterviewMapper mapper = Mappers.getMapper(InterviewMapper.class);
    ...
    public InterviewModel create(InterviewModel interviewModel) {
        ...
        var interview = mapper.toModel(interviewEntityRepository.save(mapper.toEntity(InterviewModel.builder()
    ...
    public InterviewModel addQuestion(Long interviewId, Long userId, InterviewQuestionModel interviewQuestionModel) {
        ...
        var interview = mapper.toModel(interviewEntityRepository.findByIdAndUserId(interviewId, userId).orElseThrow());
